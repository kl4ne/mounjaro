/**
 * GLP-1 Companion v5.4.0 — initial TypeScript domain contracts.
 *
...
export type AiReportType = 'ask-data' | 'weekly-checkin' | 'pattern-finder' | 'visit-prep' | 'progress-comparison' | 'personal-progress';
