...
function logBowelMovementNow() {
    ...
    if (!state.daysData[todayStr])
        state.daysData[todayStr] = { water: 0, waterUpdatedAt: 0, waterEvents: [], activityMinutes: 0, activityUpdatedAt: 0, meals: [], bowelMovements: [], bowelMovementRecords: [], bowelMovementsUpdatedAt: 0, symptoms: { hunger: 3, nausea: 'none', heartburn: 'none', sulfur: 'none', fatigue: 'none', notes: '' }, symptomsUpdatedAt: 0, electrolytes: { mg: false, k: false, na: false, multi: false }, electrolytesUpdatedAt: 0 };
