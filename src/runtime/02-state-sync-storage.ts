...
function ensureV4State() {
    ...
    state.settings.weightGoalConfigured = typeof state.settings.weightGoalConfigured === 'boolean' ? state.settings.weightGoalConfigured : Number(legacyFields.goalWeight) > 0;
    state.settings.proteinGoalConfigured = typeof state.settings.proteinGoalConfigured === 'boolean' ? state.settings.proteinGoalConfigured : Number(legacyFields.proteinGoal) > 0;
    state.settings.waterGoalConfigured = typeof state.settings.waterGoalConfigured === 'boolean' ? state.settings.waterGoalConfigured : Number(legacyFields.waterGoal) > 0;
