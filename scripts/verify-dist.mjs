...
if (unexpected11) throw new Error('Unexpected runtime 11 output: v5.5.0 must use the proven 10-module runtime architecture');
...
if (!html.includes('v5.5.0')) throw new Error('dist/index.html does not identify v5.5.0');
...
if (!sw.includes("v5.5.0-pwa")) throw new Error('Service worker build ID is not v5.5.0-pwa');
...
await walk('dist');
console.log(`Verified v5.5.0 Vite dist: ${files.length} files, 10 runtime modules, AI Usage Analytics + AI History + Timeline/Progress Comparison present.`);
